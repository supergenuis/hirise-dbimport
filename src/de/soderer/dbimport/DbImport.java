...
import de.soderer.dbimport.utilities.FileUtilities;
import de.soderer.dbimport.utilities.IoUtilities;
import de.soderer.dbimport.utilities.LangResources;
import de.soderer.dbimport.utilities.NumberUtilities;
import de.soderer.dbimport.utilities.ParameterException;
import de.soderer.dbimport.utilities.UpdateableConsoleApplication;
import de.soderer.dbimport.utilities.Utilities;
import de.soderer.dbimport.utilities.Version;
import de.soderer.dbimport.utilities.appupdate.ApplicationUpdateUtilities;
import de.soderer.dbimport.utilities.console.ConsoleMenu;
import de.soderer.dbimport.utilities.console.ConsoleType;
import de.soderer.dbimport.utilities.console.ConsoleUtilities;
import de.soderer.dbimport.utilities.console.PasswordConsoleInput;
import de.soderer.dbimport.utilities.db.DbNotExistsException;
import de.soderer.dbimport.utilities.db.DbUtilities;
import de.soderer.dbimport.utilities.db.DbUtilities.DbVendor;
import de.soderer.dbimport.utilities.http.HttpUtilities;
import de.soderer.dbimport.utilities.worker.WorkerParentDual;
...
//			System.out.println("main_arguments[" + i + "]:" + arguments[i]);
//		}
	 ...
	 * @return
	 */
	public static int _main(final String[] args) {
...
//		}
		...
		try {
			...
			if (openMenu) {
				...
				de.soderer.dbimport.utilities.swing.SwingUtilities.setSystemLookAndFeel();
	 ...
	 * Import.
	 *
	 * @param dbImportDefinition the db csv import definition
	 * @throws Exception the exception
	 */
		...
		if (!dbImportDefinitionToExecute.isInlineData()) {
			if (dbImportDefinitionToExecute.getImportFilePathOrData().contains("?") || dbImportDefinitionToExecute.getImportFilePathOrData().contains("*")) {
				...
				if (directoryPath.contains("?") || directoryPath.contains("*")) {
					...
					//String filePatternFmt = filePattern.replace(".", "\\.").replace("?", ".").replace("*", ".*");
					String filePatternFmt = filePattern;
					filesToImport = FileUtilities.getFilesByPattern(new File(directoryPath), filePatternFmt, false);
//					System.out.println("filePatternFmt-->"+filePatternFmt);
//					System.out.println("directoryPath-->"+directoryPath);
	...
	/* (non-Javadoc)
	 * @see de.soderer.dbimport.utilities.WorkerParentSimple#showUnlimitedProgress()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.soderer.dbimport.utilities.WorkerParentSimple#showProgress(java.util.Date, long, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.soderer.dbimport.utilities.WorkerParentSimple#showDone(java.util.Date, java.util.Date, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.soderer.dbimport.utilities.WorkerParentSimple#cancel()
	 */
	@Override
