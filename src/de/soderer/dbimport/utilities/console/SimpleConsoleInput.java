package de.soderer.dbimport.utilities.console;
...
import de.soderer.dbimport.utilities.console.ConsoleUtilities.TextAttribute;
...
public class SimpleConsoleInput {
	...
	public String readInput() throws Exception {
		//System.out.println("ConsoleType-->"+ConsoleUtilities.getConsoleType().toString());
